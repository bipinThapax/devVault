  ...
  return (
    <nav className="px-10 py-6  z-30 flex flex-wrap justify-between items-center  font-semibold box-border bg-[#161515] sticky top-0">
      ...
      <ul className="list-none  ml-35 flex gap-10 items-center text-gray-500 ">
        <li className="  relative  hover:text-white transition-all duration-500 ease-out after:absolute after:left-0 after:-bottom-px after:h-[2.5px] after:w-0 after:bg-[#114de5]  cursor-pointer hover:after:w-full hover:after:transition-all hover:after:ease-in-out hover:after:duration-500 after:rounded active:after:w-[70%]  ">
          Home
        </li>
        <li className="  relative  hover:text-white transition-all duration-500 ease-out after:absolute after:left-0 after:-bottom-px after:h-[2.5px] after:w-0 after:bg-[#114de5]  cursor-pointer hover:after:w-full hover:after:transition-all hover:after:ease-in-out hover:after:duration-500 after:rounded active:after:w-[70%]  ">
          Features
